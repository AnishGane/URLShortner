...
const Faqs = () => {
    ...
    return (
        <div className="py-4 sm:py-8">
            <h2 className="text-2xl md:text-3xl text-center font-medium mb-8">FAQs <span className="text-primary text-sm font-normal">(Frequently Asked Questions)</span></h2>
            <Accordion
